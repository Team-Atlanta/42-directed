...
// called func -> caller inst
typedef llvm::DenseMap<llvm::Function *, CallBaseSet> CallerMap;
typedef llvm::DenseMap<llvm::CallBase *, FuncSet> CalleeMap;
typedef llvm::DenseMap<llvm::Function *, FuncSet> CallerMapFunc;
/****************** end Call Graph **************/
